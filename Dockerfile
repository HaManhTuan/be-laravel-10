...
RUN chown -R www-docker:www-docker /var/cache/nginx /etc/nginx /var/log/nginx /var/run/nginx.pid
...
RUN composer install --no-dev ; \
    chown -R www-docker:www-docker /var/www && \
    chown -R www-docker:www-docker /var/www/storage/logs && \
